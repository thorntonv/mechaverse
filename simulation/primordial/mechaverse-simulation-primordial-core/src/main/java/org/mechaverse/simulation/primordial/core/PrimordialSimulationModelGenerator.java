...
public class PrimordialSimulationModelGenerator extends
  ...
  public static final int DEFAULT_SUB_ENVIRONMENT_COUNT = 0;//Runtime.getRuntime().availableProcessors() - 1;
  ...
  protected PrimordialSimulationModel createModel() {
    ...
    model.setEntityMaxCountPerEnvironment(1048560 / 8);
    model.setEntityMinReproductiveAge(200);
    model.setEntityInitialEnergy(1200);
    model.setEntityMaxEnergy(model.getEntityInitialEnergy() * 10);
