...
public abstract class AbstractSimulation<
  ...
  private final EnvironmentFactory<SIM_MODEL, ENV_MODEL, ENT_MODEL, ENV> environmentFactory;

  private SIM_MODEL model;
  private final List<ENV> environments = new ArrayList<>();
  private final RandomGenerator random;


  public AbstractSimulation(
      SimulationModelGenerator<SIM_MODEL> simulationModelGenerator,
      EnvironmentFactory<SIM_MODEL, ENV_MODEL, ENT_MODEL, ENV> environmentFactory) {
  ...
  public void step() {
    ...
    for (ENV environment : environments) {
      environment.update(model, random);
    }
